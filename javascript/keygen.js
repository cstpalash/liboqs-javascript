...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 16967056,
    DYNAMIC_BASE = 22209936,
    DYNAMICTOP_PTR = 16966896;
...
var wasmBinaryFile = 'keygen.wasm';
...
// STATICTOP = STATIC_BASE + 16966032;
...
/** @type {function(...*):?} */
var _GetKeyPair = Module["_GetKeyPair"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["GetKeyPair"].apply(null, arguments)
};
